...
// Using two recursive methods, all r-permutations of the n^2-set are computed.
// Every combination of r-permutations is found and tested in the buildSquares
// method to determine if a magic square is formed. (Only works for 3 x 3 magic squares)
...
public class bruteForce2 {
    ...
    // building magic squares with all r-permutations (will only work for n=3) ------ OLD VERSION
